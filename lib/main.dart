...
if(Firebase.apps.isEmpty) {
  if(Platform.isAndroid){
    ...
    //     apiKey: "AIzaSyCXrNrm-ALvaf7hoGT_Nbi3srmXJY23TnI",
    //     projectId: "sixvalley-38c61",
    //     messagingSenderId: "92573779497",
    //     appId: "1:92573779497:android:0890894c697d60d379fe38"
    // ));
  }
  else{
    await Firebase.initializeApp();
  ...
  runApp(MultiProvider(providers: [
      ...
      // ChangeNotifierProvider(create: (context) => CheckoutController(checkoutServiceInterface: CheckoutService(checkoutRepositoryInterface: CheckoutRepository(),),)),
    ],
